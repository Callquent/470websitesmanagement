...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 16 Mai 2016 à 08:44
...
INSERT INTO `language` (`l_id`, `l_title`, `l_title_url`, `l_color`) VALUES
(1, 'HTML', 'html', '#E44D26'),
...
--
-- Structure de la table `website_backoffice`
--

DROP TABLE IF EXISTS `website_backoffice`;
CREATE TABLE IF NOT EXISTS `website_backoffice` (
...
--
-- Structure de la table `website_database`
--

DROP TABLE IF EXISTS `website_database`;
CREATE TABLE IF NOT EXISTS `website_database` (
...
-- Structure de la table `website_ftp`
--

DROP TABLE IF EXISTS `website_ftp`;
CREATE TABLE IF NOT EXISTS `website_ftp` (
...
--
-- Structure de la table `website_info`
--
...
--
-- Contraintes pour la table `website_backoffice`
--
ALTER TABLE `website_backoffice`
  ADD CONSTRAINT `fk_id_bo` FOREIGN KEY (`w_id_info`) REFERENCES `website_info` (`w_id`);

--
-- Contraintes pour la table `website_database`
--
ALTER TABLE `website_database`
  ADD CONSTRAINT `fk_id_db` FOREIGN KEY (`w_id_info`) REFERENCES `website_info` (`w_id`);

--
-- Contraintes pour la table `website_ftp`
--
ALTER TABLE `website_ftp`
  ADD CONSTRAINT `fk_id_ftp` FOREIGN KEY (`w_id_info`) REFERENCES `website_info` (`w_id`);

--
-- Contraintes pour la table `website_info`
--
ALTER TABLE `website_info`
  ADD CONSTRAINT `fk_c_id` FOREIGN KEY (`c_id`) REFERENCES `category` (`c_id`),
  ADD CONSTRAINT `fk_l_id` FOREIGN KEY (`l_id`) REFERENCES `language` (`l_id`);

--
-- Contraintes pour la table `whois`
--
ALTER TABLE `whois`
  ADD CONSTRAINT `fk_id_whois` FOREIGN KEY (`w_id_info`) REFERENCES `website_info` (`w_id`);
