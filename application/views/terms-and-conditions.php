                        ...
                        <div class="container p-8">
                            <div class="card p-20">
                                <div class="single post-text">
                                    <p style="text-align: center;"><strong>POLITIQUE DE CONFIDENTIALITÉ</strong><br><strong><span id="span_id_nom_organisme_entreprise">470websitesmanagement</span></strong><br> </p>
                                    <blockquote><p><strong>1.Collecte de l’information</strong></p>
                                    ...
                                    <p>En outre, nous recevons et enregistrons automatiquement des informations à partir de votre ordinateur et navigateur, y compris votre adresse IP, vos logiciels et votre matériel, et la page que vous demandez.</p></blockquote>
                                    <h3></h3>
                                    <blockquote><p><strong>2. Utilisation des informations<br>
                                    </strong></p>
                                    ...
                                    <p>Les informations non-privées, cependant, peuvent être fournies à d’autres parties pour le marketing, la publicité, ou d’autres utilisations.</p></blockquote>
                                    <h3></h3>
                                    <blockquote><p><strong>5. Protection des informations<br>
                                    </strong></p>
                                    ...
                                    <p>Oui. Nos cookies améliorent l’accès à notre site et identifient les visiteurs réguliers. En outre, nos cookies améliorent l’expérience d’utilisateur grâce au suivi et au ciblage de ses intérêts. Cependant, cette utilisation des cookies n’est en aucune façon liée à des informations personnelles identifiables sur notre site.</p></blockquote>
                                    <p>&nbsp;</p>
                                    <blockquote><p><strong>6. Se désabonner<br>
                                    </strong></p>
                                    <p>Nous utilisons l’adresse e-mail que vous fournissez pour vous envoyer des informations et mises à jour relatives à votre commande, des nouvelles de l’entreprise de façon occasionnelle, des informations sur des produits liés, etc. Si à n’importe quel moment vous souhaitez vous désinscrire et ne plus recevoir d’e-mails, des instructions de désabonnement détaillées sont incluses en bas de chaque e-mail.</p></blockquote>
                                    <h3></h3>
                                    <blockquote><p><strong>7. Consentement</strong><br>
                                    En utilisant notre site, vous consentez à notre politique de confidentialité.</p></blockquote>
                                    <div class="login d-flex flex-column flex-sm-row align-items-center justify-content-center mt-8 mb-6 mx-auto">
                                    <a class="link text-secondary" href="<?php echo site_url('registration'); ?>">go to registration form -></a>
                                </div>
                                </div>
                            </div>
                        </div>
