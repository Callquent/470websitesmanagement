										...
										<v-toolbar flat color="white">
											...
											<v-dialog v-model="dialog_groups_member" max-width="500px">
												<template v-slot:activator="{ on }">
													<v-btn color="primary" dark class="mb-2" v-on="on">New Groups Member</v-btn>
												</template>
												<v-card>
													<v-card-title>
													...
													<v-card-actions>
														...
														<v-btn color="blue darken-1" text @click="f_addGroupMember()">Save</v-btn>
														<v-btn color="blue darken-1" text @click="dialog_groups_member = false">Cancel</v-btn>
													</v-card-actions>
												</v-card>
											</v-dialog>
										</v-toolbar>
