var DatatableColumnRenderingDemo= {
    init:function() {
        !function() {
            var t=$(".table-dashboard").mDatatable( {
                data: {
                    type:"remote", source: {
                        read: {
                ...
                , {
                    width:200, field:"CompanyAgent", title:"Agent", template:function(t) {
                        var a=mUtil.getRandomInt(1, 14), e="100_"+a+".jpg";
                        if(a>8)output='<div class="m-card-user m-card-user--sm">\t\t\t\t\t\t\t\t<div class="m-card-user__pic">\t\t\t\t\t\t\t\t\t<img src="./assets/app/media/img/users/'+e+'" class="m--img-rounded m--marginless" alt="photo">\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t<div class="m-card-user__details">\t\t\t\t\t\t\t\t\t<span class="m-card-user__name">'+t.CompanyAgent+'</span>\t\t\t\t\t\t\t\t\t<a href="" class="m-card-user__email m-link">'+t.CompanyName+"</a>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t</div>";
                        else {
                            var s=["success", "brand", "danger", "accent", "warning", "metal", "primary", "info"][mUtil.getRandomInt(0, 7)];
                            output='<div class="m-card-user m-card-user--sm">\t\t\t\t\t\t\t\t<div class="m-card-user__pic">\t\t\t\t\t\t\t\t\t<div class="m-card-user__no-photo m--bg-fill-'+s+'"><span>'+t.CompanyAgent.substring(0, 1)+'</span></div>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t<div class="m-card-user__details">\t\t\t\t\t\t\t\t\t<span class="m-card-user__name">'+t.CompanyAgent+'</span>\t\t\t\t\t\t\t\t\t<a href="" class="m-card-user__email m-link">'+t.CompanyName+"</a>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t</div>"
                        }
                        return output
                    }
                }
